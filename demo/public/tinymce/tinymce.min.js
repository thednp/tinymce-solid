    ...
    zu = (e, t) => {
      ...
      return dr(n)
        ...
        : n
          ? Pi(n)
            ? I.some(
                e ? Ji.before(n) : pr((o = n)) ? Ji.before(o) : Ji.after(o),
              )
            : ((e, t, n) => {
        ...
        e
          ? ((e, t) =>
              xh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    ju(e, Ji.after(t)).orThunk(() => Hu(e, Ji.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(qh.partialTable(r, I.none()));
                    {
                      const e = Jh(n, t);
                      return I.some(
                        qh.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                jb(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (Kb(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
                                ...
                                y(t)
                                  ...
                                  : e && vr(t.nextSibling)
                                    ...
                                    : !e && vr(t.previousSibling)
                                      ? I.some(
                                          Hx.moveToElement(t.previousSibling),
                                        )
